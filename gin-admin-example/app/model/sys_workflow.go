...
var WorkflowBusinessStruct map[string]func() GAE_Workflow
var WorkflowBusinessTable map[string]func() interface{}

type GAE_Workflow interface {
...
type WorkflowBase struct {
	...
	BusinessID        uint   `json:"businessID" gorm:"<-:false;column:id"`
...
func (w WorkflowBase) CreateWorkflowMove() (businessModel *WorkflowMove) {
	return &WorkflowMove{
		GAE_MODEL:         global.GAE_MODEL{ID: w.WorkflowMoveID},
